...
import static com.example.vehicleemergencyap.R.layout.activity_driver_sign_up;
...
//      private TextInputLayout mCarPlateNumberTextInputLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(activity_driver_sign_up);
...
//                ProgressDialog progressDialog = new ProgressDialog(DriverSignUp.this);
...
//                                                    Toast.makeText(DriverSignUp.this, "Registration successful", Toast.LENGTH_SHORT).show();
//                                                    finish();
//                                                }
//                                            })
...
//                                                    // progressDialog.dismiss();
//                                                    Toast.makeText(DriverSignUp.this, "Failed to register: " + e.getMessage(), Toast.LENGTH_SHORT).show();
//                                                }
//                                            });
//                                } else {
//                                    // progressDialog.dismiss();
//                                    Toast.makeText(DriverSignUp.this, "Failed to register: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
//                                }
//                            }
//                        });
//            }
